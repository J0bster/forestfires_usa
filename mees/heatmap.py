...
def create_total_fires_map(merged_gdf):
    ...
    plot_map(
        ...
        output_path="/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_total_fires.html",
    )
...
def create_total_acres_map(merged_gdf):
    ...
    plot_map(
        ...
        output_path="/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_total_acres.html",
    )
...
def create_gi_map_for_fires(merged_gdf):
    ...
    plot_zscore_map(
        merged_gdf,
        "/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_Gi.html",
    )
...
def create_drought_map(merged_gdf):
    ...
    plot_map(
        ...
        value_col=val_col,
        caption=caption,
        output_path="/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_drought.html",
    )
...
def create_gi_map_for_drought(merged_gdf):
    ...
    plot_zscore_map(
        merged_gdf,
        "/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_Gi_drought.html",
    )
...
def create_total_fires_map_year(merged_gdf, year, max_value=None):
    ...
    plot_map(
        ...
        output_path=f"/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_total_fires_{year}.html",
        max_value=max_value,
    )
...
def create_gi_map_for_fires_year(merged_gdf, year):
    ...
    plot_zscore_map(
        merged_gdf,
        f"/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_Gi_{year}.html",
    )
...
def create_drought_map_year(merged_gdf, year, max_value=None):
    ...
    plot_map(
        ...
        output_path=f"/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_drought_{year}.html",
        max_value=max_value,
    )
...
def create_gi_map_for_drought_year(merged_gdf, year):
    ...
    plot_zscore_map(
        merged_gdf,
        f"/home/mees/Desktop/forestfires_usa/mees/texas_choropleth_Gi_drought_{year}.html",
    )


def main():
    shapefile_path = "/home/mees/Desktop/forestfires_usa/dataset_gitignore/County_shape.geojson"
    fire_data_path = (
        "/home/mees/Desktop/forestfires_usa/dataset/texas_fires_drought.csv"
    )
    drought_data_path = (
        "/home/mees/Desktop/forestfires_usa/dataset/drought_county_tx.csv"
    )
    year = 2011
